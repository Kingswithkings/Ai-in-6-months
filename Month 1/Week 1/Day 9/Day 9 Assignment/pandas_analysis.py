...
def analyze_people_data(filepath='people.csv'):
    """
    Loads people.csv, adds a score column, assigns age groups, shows group counts, and plots age vs score.
    ...
    try:
        ...
        age_counts = df['age_group'].value.counts()
        ...
        for name, group in groups:
            ...
            plt.grind(True, linestyle='--', alpha=0.6)
            plt.show()
